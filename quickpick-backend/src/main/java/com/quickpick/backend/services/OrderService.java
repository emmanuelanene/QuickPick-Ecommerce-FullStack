...
import com.quickpick.backend.auth.dto.OrderResponse;
import com.quickpick.backend.auth.entities.User;
import com.quickpick.backend.dto.OrderDetails;
import com.quickpick.backend.dto.OrderItemDetail;
import com.quickpick.backend.dto.OrderRequest;
import com.quickpick.backend.entities.*;
import com.quickpick.backend.repositories.OrderRepository;
    ...
    public OrderResponse createOrder(OrderRequest orderRequest, Principal principal) throws Exception {
        ...
        List<OrderItem> orderItems = orderRequest.getOrderItemRequests().stream().map(orderItemRequest -> {
            try {
                ...
                // You return the newly created item.
                return orderItem;
            }
